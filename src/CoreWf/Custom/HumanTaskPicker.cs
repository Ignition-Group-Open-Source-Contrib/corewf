...
namespace System.Activities.Custom
{
    ...
    public sealed class HumanTaskPicker : NativeActivity
    {
        private const string pickStateProperty = "System.Activities.Statements.Pick.PickState";
        private Collection<HumanTaskBranch> branches;
        ...
        public Collection<HumanTaskBranch> Branches
        {
            get
            {
                if (this.branches == null)
                {
                    this.branches = new ValidatingCollection<HumanTaskBranch>
                    {
        ...
        protected override void CacheMetadata(NativeActivityMetadata metadata)
        {
            ...
            foreach (HumanTaskBranch branch in this.Branches)
            {
